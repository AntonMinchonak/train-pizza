...
export default function Sort() {
  ...
  const [showPopup, schangeVisibility] = React.useState(false);
  ...
  return (
    <div className="sort">
      <div className="sort__label">
        ...
        <b>Сортировка по:</b>
        <span onClick={() => schangeVisibility(!showPopup)}>{activeSort}</span>
      </div>
      <div className="sort__popup" style={showPopup ? {} : { display: "none" }}>
        <ul>
          {list.map((item, index) => {
            return (
              <li
